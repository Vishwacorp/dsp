...
>> P(H) = P(identical twin brothers) = (1/2)\*(1/300)  
>> P(H) = 1/600  

>> P(D|H) = P(Elvis was a twin if he was identical) = 1

>> P(D) = P(twin brothers, fraternal or identical) = (1/2)\*(1/300)+(1/4)\*(1/125)  
>> P(D) = 11/3000

>> P(H|D) = P(Elvis was an identical twin given he had a twin brother  
>> P(H|D) = P(H)\*P(D|H)/P(D)  
>> P(H|D) = (1/600)\*(1)/(11/3000)  
>> P(H|D) = **5/11**
...
>> A frequentist approach is objective since it does not rely on priors or assign a probability to hypotheses. Bayesian statistics, while subjective, follows principles of deductive logic.
